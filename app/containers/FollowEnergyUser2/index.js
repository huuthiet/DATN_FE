...
const FollowEnergyUser2 = props => {
  ...
  return (
    <>
      ...
      <div className="title-abc">Theo dõi điện năng: {nameRoom}</div>
      ...
      <div>
        <Grid container justify="center">
          ...
          <Grid item xs={12} sm={4} md={3}
            style={{
              backgroundColor: 'white', height: '300px', margin: '8px', justifyContent: 'center',
          ...
          <Grid item xs={12} sm={4} md={4} style={{
            height: '300px', margin: '8px', borderRadius: '20px', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)',
